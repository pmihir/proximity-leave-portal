...
export default function ApplyLeave({ session, slackWebhookUrl }) {
  ...
  return (
    <div className={styles.container}>
      {console.log("notifcation status ", notificationStatus)}
      <Head>
                ...
                {isApi && (
                  <div className={styles.progressWrapper}>
                    <div className={styles.progress}>
                      ...
                      <div>
                        {notificationStatus.slack === null ? (
                          <CircularProgress
                            style={{ height: "15px", width: "15px" }}
                          />
                        ) : notificationStatus.slack ? (
                          <Checkmark />
                        ) : (
                          <Cross />
                        )}
                    ...
                    <div className={styles.progress}>
                      ...
                      <div>
                        {notificationStatus.timely === null ? (
                          <CircularProgress
                            style={{ height: "15px", width: "15px" }}
                          />
                        ) : notificationStatus.timely ? (
                          <Checkmark />
                        ) : (
                          <Cross />
                        )}
